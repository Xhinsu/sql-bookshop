...
('Neil Hughes','Neil runs the Java programme at Northcoders, but used to make his living by talking publicly about custard and writing books about magical shops. He once shamelessly inserted himself into a list of very famous authors for a database practice exercise.'),
